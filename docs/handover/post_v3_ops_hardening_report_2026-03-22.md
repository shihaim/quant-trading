...
- [S5 세션 하드닝](../reports/s5_auth_session_lifecycle_hardening_2026-03-22.md)
- [S6 정합성 하드닝](../reports/s6_order_attempts_consistency_hardening_2026-03-22.md)
- [S6 운영 런북](../runbooks/order_attempts_unique_constraints_runbook_2026-03-22.md)
- [S7 리스크 확장](../reports/s7_risk_policy_expansion_2026-03-22.md)
...
- 최신 admin role 운영 기준: `docs/reports/s5_admin_role_separation_hardening_2026-03-26.md`
- 최신 운영 절차: `docs/ops_runbook.md`의 `Admin Role Operation (DB-first, 2026-03-28)`
- F2 호환성 정리 계획: `docs/reports/f2_v3_compatibility_fallback_cleanup_plan_2026-05-16.md`
